...
and 
display name & balance on demand.

Make sure you write a user interactive code.

Do make sure you check all the boundary conditions.// decided before you actually write the program

class along right access modifiers for the data members and the member functions
...
int main() {
  ...
  static int id=12347;
//Details of present Account Holders
